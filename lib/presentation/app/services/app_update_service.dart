      ...
      if (newVersion > currentVersion) {
        if (context.mounted) {
          showConfirmationDialogue(
            ...
            forceUpdate,
                () async {
              final appId = Platform.isAndroid ? 'com.pregnancy.ovulation.tracker.mkg' : 'id6444229851';
              final url = Uri.parse(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        style: ButtonStyle(
                          backgroundColor: WidgetStateProperty.all<Color>(ConstantColors.primaryColor),
                        ...
                        child: Text(
                          "UPDATE".tr,
                          style: context.titleMedium?.copyWith(color: ConstantColors.whiteColor),
                        ),
                      ),
                      forceUpdate
